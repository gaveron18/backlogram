        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="absolute -inset-10 bg-blue-600/10 blur-[100px] rounded-full -z-10 animate-pulse" />
              <div className="p-2 rounded-[2rem] bg-gradient-to-br from-slate-200 dark:from-slate-800 to-slate-100 dark:to-slate-950 border border-slate-200 dark:border-slate-800 shadow-2xl">
                <div className="bg-white dark:bg-slate-900 rounded-[1.5rem] overflow-hidden relative">
                  <div className="h-10 bg-slate-50 dark:bg-slate-950 flex items-center px-6 gap-2 border-b border-slate-200 dark:border-slate-800">
                    <div className="w-2.5 h-2.5 rounded-full bg-slate-200 dark:bg-slate-800" />
                    <div className="w-2.5 h-2.5 rounded-full bg-slate-200 dark:bg-slate-800" />
                    <div className="w-2.5 h-2.5 rounded-full bg-slate-200 dark:bg-slate-800" />
                  ...
                  <div className="p-6 space-y-6">
                    <div className="flex gap-4">
                      <div className="w-12 h-12 rounded bg-slate-100 dark:bg-slate-800 animate-pulse" />
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4">
                      <div className="h-20 bg-slate-100 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800" />
                      <div className="h-20 bg-slate-100 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-800" />
                    </div>
                  </div>
                  {/* NDA overlay */}
                  <div className="absolute inset-0 flex items-center justify-center bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm rounded-[1.5rem]">
                    <div className="flex flex-col items-center gap-3">
                      <div className="px-6 py-2 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-xl">
                        <span className="text-2xl font-black text-slate-600 dark:text-slate-300 tracking-[0.3em] uppercase">NDA</span>
                      </div>
                      <p className="text-xs text-slate-400 dark:text-slate-500 text-center max-w-[160px]">Скриншоты не публикуются по условиям соглашения</p>
                    </div>
                  </div>
                </div>
              </div>
